...
/*!*************************************************!*\
  !*** ./src/backend/customizer/js/builder-v2.js ***!
  \*************************************************/
  ...
  CustomizeBuilder_V2 = function (options, id) {
    var Builder = {
      ...
      addNewWidget: function (device, row_id, col_id, node, index) {
        var that = this;
        var panel, row, col;
        panel = that.container.find(".customify--device-panel.customify--panel-" + device);
          ...
          $('.customify--cb-row', devicePanel).each(function () {
            ...
            if (row_id) {
              $('.col-items', row).each(function () {
                ...
                if (col_id) {
                  var colData = _.map($(" > .grid-stack-item", col), function (el) {
                    el = $(el);
                    return {
                      id: el.data("id") || ""
                    };
      ...
      panelLayoutCSS: function () {
        ...
        if (is_rtl) {
          this.container.find(".customify--cb-inner").css({
...
/******/ })()
;
//# sourceMappingURL=builder-v2.js.map