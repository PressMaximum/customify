...
const entries = {
	...
	'backend/customizer/preview-colors':         path.resolve( __dirname, 'src/preview-colors/customizer/index.js' ),
	'backend/customizer/preview-colors-preview': path.resolve( __dirname, 'src/preview-colors/customizer/preview.js' ),
