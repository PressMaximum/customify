    ...
    function customize() {
        ...
        if ( ! class_exists('Customify_Pro') ) {
            ...
            $config[] = array(
                ...
                'type' => 'custom_html',
                'section'  => $section,
                'description' => sprintf( __( 'Submenu typography and styling settings is a part of Advanced Header & Footer builder modules which only available in Customify Pro, <a target="_blank" href="https://wpcustomify.com/help/documentation/customify-pro-modules/advanced-header-footer-builder/">learn more about it here</a>',  'customify' ) ),
