	...
	function template() {
		...
		if ( ! apply_filters( 'customify/is_pro_activated', false ) ) {
			...
			<script type="text/html" id="customify-upsell-tmpl">
				<p class="customify-upsell-panel"><?php printf( __( 'Enjoy building? Upgrade to <a target="_blank" href="%s">Customify Pro</a> to get more builder items and other premium features</a>.', 'customify' ), esc_url( customify_get_pro_url( 'panel_text' ) ) ); ?></p>
			</script>
			<?php
		}
	}
