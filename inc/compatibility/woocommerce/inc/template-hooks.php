...
function customify_wc_catalog_view_mod(){
    ...
    <div class="wc-view-switcher">
        <span class="wc-view-mod wc-svg-btn wc-grid-view <?php echo ( $default == 'grid' ) ? 'active' : ''; ?>" data-mod="grid">
        ...
        <span class="wc-view-mod wc-svg-btn wc-list-view <?php echo ( $default == 'list' ) ? 'active' : ''; ?>" data-mod="list">
