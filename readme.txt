...
Font Awesome 6 Free, Copyright Fonticons, Inc.
Icons: CC BY 4.0 License, https://creativecommons.org/licenses/by/4.0/
Fonts: SIL OFL 1.1 License, https://scripts.sil.org/OFL
Code: MIT License, https://opensource.org/licenses/MIT
Source: https://fontawesome.com

WooCommerce icons (bundled WooCommerce icon font)
License: GPLv3, https://github.com/woocommerce/woocommerce/blob/trunk/LICENSE.md
...
* FIXED: Footer default padding for tablet/mobile.
...
* FIXED: Product grid mobile columns not changing.

= 0.4.12 =
* FIXED: Fix security issues.
* FIXED: Invalid limit type passed to wc_get_related_products.

= 0.4.11 =
* UPDATED: WooCommerce template files.
* FIXED: Issue "load_theme_textdomain"
...
= 0.2.0 =
* NOTES: This is a major update with new features and Customizer settings re-structure, if you see any visual changes on the site front-end please go to the Customizer to update options.
