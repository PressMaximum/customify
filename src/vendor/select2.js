! function(e) {
	...
	(A = e && e.fn && e.fn.select2 && e.fn.select2.amd ? e.fn.select2.amd : A) && A.requirejs || (A ? t = A : A = {}, a = {}, l = {}, c = {}, u = {}, d = Object.prototype.hasOwnProperty, p = [].slice, h = /\.js$/, s = function(e, t) {
		var n, i, o = w(e),
			s = o[0];
		return t = t[1], e = o[1], s && (n = _(s = y(s, t))), s ? e = n && n.normalize ? n.normalize(e, (i = t, function(e) {
			return y(e, i)
		})) : y(e, t) : (s = (o = w(e = y(e, t)))[0], e = o[1], s && (n = _(s))), {
			f: s ? s + "!" + e : e,
			n: e,
			pr: s,
			p: n
		...
		if ("undefined" == y || "function" == y) {
			for (t = !t.length && i.length ? ["require", "exports", "module"] : t, h = 0; h < t.length; h += 1)
				if ("require" === (d = (p = s(t[h], w)).f)) g[h] = r.require(e);
				else if ("exports" === d) g[h] = r.exports(e), f = !0;
			else if ("module" === d) c = g[h] = r.module(e);
			else if (m(a, d) || m(l, d) || m(u, d)) g[h] = _(d);
			else {
				if (!p.p) throw new Error(e + " missing " + d);
				p.p.load(p.n, v(o, !0), function(e) {
					return function(t) {
						a[e] = t
					}
				}(d), {}), g[h] = a[d]
			}
			y = i ? i.apply(a[e], g) : void 0, e && (c && c.exports !== n && c.exports !== a[e] ? a[e] = c.exports : y === n && f || (a[e] = y))
		} else e && (a[e] = i)
	}, f = t = o = function(e, t, a, l, u) {
		if ("string" == typeof e) return r[e] ? r[e](t) : _(s(e, b(t)).f);
		if (!e.splice) {
			if ((c = e).deps && o(c.deps, c.callback), !t) return;
			t.splice ? (e = t, t = a, a = null) : e = n
		}
		return t = t || function() {}, "function" == typeof a && (a = l, l = u), l ? i(n, e, t, a) : setTimeout(function() {
			i(n, e, t, a)
		}, 4), o
	}, o.config = function(e) {
		return o(e)
	}, f._defined = a, (g = function(e, t, n) {
		if ("string" != typeof e) throw new Error("See almond README: incorrect module build, no module name");
		t.splice || (n = t, t = []), m(a, e) || m(l, e) || (l[e] = [e, t, n])
	}).amd = {
		jQuery: !0
	}, A.requirejs = f, A.require = t, A.define = g), A.define("almond", function() {}), A.define("jquery", [], function() {
		var t = e || $;
		...
		t.Extend = function(e, t) {
			...
			for (var l = 0; l < i.length; l++) {
				...
				s.prototype[c] = function(e) {
					var n = function() {},
						i = (e in s.prototype && (n = s.prototype[e]), t.prototype[e]);
					return function() {
		...
		return t.Extend(n, t.Observable), n.prototype.render = function() {
			...
			var n = this.options.get("escapeMarkup"),
				i = (this.clear(), this.hideLoading(), e('<li role="alert" aria-live="assertive" class="select2-results__option"></li>')),
			...
			var i, o = document.createElement("li"),
				s = (o.className = "select2-results__option", {
					role: "option",
					"aria-selected": "false"
				}),
				r = window.Element.prototype.matches || window.Element.prototype.msMatchesSelector || window.Element.prototype.webkitMatchesSelector;
			for (i in (null != n.element && r.call(n.element, ":disabled") || null == n.element && n.disabled) && (delete s["aria-selected"], s["aria-disabled"] = "true"), null == n.id && delete s["aria-selected"], null != n._resultId && (o.id = n._resultId), n.title && (o.title = n.title), n.children && (s.role = "group", s["aria-label"] = n.text, delete s["aria-selected"]), s) o.setAttribute(i, s[i]);
			if (n.children) {
				r = e(o);
				for (var a = document.createElement("strong"), l = (a.className = "select2-results__group", e(a), this.template(n, a), []), c = 0; c < n.children.length; c++) {
					var u = n.children[c];
			...
			this.$results.attr("id", s), n.on("results:all", function(e) {
				...
				var e, t = o.getHighlightedResults(),
					...
					i = n.index(t);
				i <= 0 || (i -= 1, 0 === t.length && (i = 0), (t = n.eq(i)).trigger("mouseenter"), n = o.$results.offset().top, t = t.offset().top, e = o.$results.scrollTop() + (t - n), 0 === i ? o.$results.scrollTop(0) : t - n < 0 && o.$results.scrollTop(e))
			}), n.on("results:next", function() {
				var e, t, n = o.getHighlightedResults(),
					i = o.$results.find("[aria-selected]");
				(n = i.index(n) + 1) >= i.length || ((i = i.eq(n)).trigger("mouseenter"), e = o.$results.offset().top + o.$results.outerHeight(!1), i = i.offset().top + i.outerHeight(!1), t = o.$results.scrollTop() + i - e, 0 === n ? o.$results.scrollTop(0) : e < i && o.$results.scrollTop(t))
				...
				t = 0 < e.deltaY && t - e.deltaY <= 0, n = e.deltaY < 0 && n <= o.$results.height(), t ? (o.$results.scrollTop(0), e.preventDefault(), e.stopPropagation()) : n && (o.$results.scrollTop(o.$results.get(0).scrollHeight - o.$results.height()), e.preventDefault(), e.stopPropagation())
			}), this.$results.on("mouseup", ".select2-results__option[aria-selected]", function(n) {
				var i = e(this),
					s = t.GetData(this, "data");
				"true" === i.attr("aria-selected") ? o.options.get("multiple") ? o.trigger("unselect", {
					originalEvent: n,
					data: s
			...
			0 !== o.length && (e = this.$results.find("[aria-selected]").index(o), t = this.$results.offset().top, i = o.offset().top, n = this.$results.scrollTop() + (i - t), i -= t, n -= 2 * o.outerHeight(!1), e <= 2 ? this.$results.scrollTop(0) : (i > this.$results.outerHeight() || i < 0) && this.$results.scrollTop(n))
		}, n.prototype.template = function(t, n) {
			var i = this.options.get("templateResult"),
				o = this.options.get("escapeMarkup");
			null == (i = i(t, n)) ? n.style.display = "none" : "string" == typeof i ? n.innerHTML = o(i) : e(n).append(i)
		}, n
		...
		return n.Extend(o, t), o.prototype.render = function() {
			...
			var n = this,
				i = (o.__super__.bind.apply(this, arguments), e.id + "-container");
		...
		return n.Extend(i, t), i.prototype.render = function() {
			...
			i.__super__.bind.apply(this, arguments), this.$selection.on("click", function(e) {
				...
				var i;
				s.options.get("disabled") || (i = e(this).parent(), i = n.GetData(i[0], "data"), s.trigger("unselect", {
					originalEvent: t,
					data: i
				}))
			})
			...
			if (this.clear(), 0 !== e.length) {
				for (var t = [], i = 0; i < e.length; i++) {
					var o = e[i],
						...
						r = this.display(o, s);
					s.append(r), (r = o.title || o.text) && s.attr("title", r), n.StoreData(s[0], "data", o), t.push(s)
				}
		...
		return i.prototype.bind = function(e, t, n) {
			...
			t.call(this, i), 0 < this.$selection.find(".select2-selection__placeholder").length || 0 === i.length || (t = this.options.get("translations").get("removeAllItems"), t = e('<span class="select2-selection__clear" title="' + t() + '">&times;</span>'), n.StoreData(t[0], "data", i), this.$selection.find(".select2-selection__rendered").prepend(t))
		}, i
		...
		return i.prototype.render = function(t) {
			...
			return this.$searchContainer = n, this.$search = n.find("input"), n = t.call(this), this._transferTabIndex(), n
		}, i.prototype.bind = function(e, i, o) {
			var s = this,
				r = i.id + "-results",
				a = (e.call(this, i, o), i.on("open", function() {
					...
					var i;
					e.stopPropagation(), s.trigger("keypress", e), s._keyUpPrevented = e.isDefaultPrevented(), e.which === n.BACKSPACE && "" === s.$search.val() && 0 < (i = s.$searchContainer.prev(".select2-selection__choice")).length && (i = t.GetData(i[0], "data"), s.searchRemoveChoice(i), e.preventDefault())
				}), this.$selection.on("click", ".select2-search--inline", function(e) {
					s.$search.val() && e.stopPropagation()
				}), (e = document.documentMode) && e <= 11);
			this.$selection.on("input.searchcheck", ".select2-search--inline", function(e) {
				a ? s.$selection.off("input.search input.searchcheck") : s.$selection.off("keyup.search")
			}), this.$selection.on("keyup.search input.search", ".select2-search--inline", function(e) {
				var t;
				a && "input" === e.type ? s.$selection.off("input.search input.searchcheck") : (t = e.which) != n.SHIFT && t != n.CTRL && t != n.ALT && t != n.TAB && s.handleSearch(e)
			})
			...
			var e;
			this.$search.css("width", "25px"), e = "" !== this.$search.attr("placeholder") ? this.$selection.find(".select2-selection__rendered").width() : .75 * (this.$search.val().length + 1) + "em", this.$search.css("width", e)
		}, i
		...
		return t.prototype.bind = function(t, n, i) {
			...
			t.call(this, n, i), n.on("*", function(t, n) {
				var i; - 1 !== e.inArray(t, s) && (i = e.Event("select2:" + t, {
					params: n = n || {}
		...
		return t.Extend(i, e), i.prototype.current = function(e) {
			...
			var t, i = this;
			e.selected = !0, n(e.element).is("option") ? (e.element.selected = !0, this.$element.trigger("change")) : this.$element.prop("multiple") ? this.current(function(t) {
				var o = [];
				(e = [e]).push.apply(e, t);
				for (var s = 0; s < e.length; s++) {
					var r = e[s].id; - 1 === n.inArray(r, o) && o.push(r)
				}
				i.$element.val(o), i.$element.trigger("change")
			}) : (t = e.id, this.$element.val(t), this.$element.trigger("change"))
		}, i.prototype.unselect = function(e) {
			var t = this;
			this.$element.prop("multiple") && (e.selected = !1, n(e.element).is("option") ? (e.element.selected = !1, this.$element.trigger("change")) : this.current(function(i) {
			...
			this.$element.children().each(function() {
				var t = n(this);
				(t.is("option") || t.is("optgroup")) && (t = o.item(t), null !== (t = o.matches(e, t))) && i.push(t)
			}), t({
				results: i
			})
			...
			var i, o = n(i);
			return (e = this._normalizeItem(e)).element = i, t.StoreData(i, "data", e), o
			...
			if (null == (i = t.GetData(e[0], "data"))) {
				if (e.is("option")) i = {
					...
					for (var o = e.children("option"), s = [], r = 0; r < o.length; r++) {
						var a = n(o[r]);
						a = this.item(a), s.push(a)
					}
					i.children = s
				}(i = this._normalizeItem(i)).element = e[0], t.StoreData(e[0], "data", i)
			}
			return i
		...
		return t.Extend(i, e), i.prototype.bind = function(e, t) {
			...
			var t;
			0 === this.$element.find("option").filter(function(t, n) {
				return n.value == e.id.toString()
			}).length && (t = this.option(e), this.addOptions(t)), i.__super__.select.call(this, e)
		}, i.prototype.convertToOptions = function(e) {
			for (var i = this, o = this.$element.find("option"), s = o.map(function() {
					return i.item(n(this)).id
				}).get(), r = [], a = 0; a < e.length; a++) {
				var l, c, u = this._normalizeItem(e[a]);
				0 <= n.inArray(u.id, s) ? (l = o.filter(function(e) {
					return function() {
						return n(this).val() == e.id
					}
				}(u)), c = this.item(l), c = n.extend(!0, {}, u, c), c = this.option(c), l.replaceWith(c)) : (l = this.option(u), u.children && (c = this.convertToOptions(u.children), t.appendMany(l, c)), r.push(l))
			}
			return r
		}, i
		...
		return t.Extend(i, e), i.prototype._applyDefaults = function(e) {
			...
			var i = this,
				o = (null != this._request && (n.isFunction(this._request.abort) && this._request.abort(), this._request = null), n.extend({
					type: "GET"
				}, this.ajaxOptions));

			function s() {
				var s = o.transport(o, function(o) {
					o = i.processResults(o, e), i.options.get("debug") && window.console && console.error && (o && o.results && n.isArray(o.results) || console.error("Select2: The AJAX results did not return an array in the `results` key of the response.")), t(o)
				}, function() {
		...
		function t(t, n, i) {
			var o, s = i.get("tags");
			if (void 0 !== (void 0 !== (o = i.get("createTag")) && (this.createTag = o), o = i.get("insertTag")) && (this.insertTag = o), t.call(this, n, i), e.isArray(s))
				for (var r = 0; r < s.length; r++) {
					var a = s[r];
					a = this._normalizeItem(a), a = this.option(a), this.$element.append(a)
				}
		}
		return t.prototype.query = function(e, t, n) {
			var i = this;
			this._removeOldTags(), null == t.term || null != t.page ? e.call(this, t, n) : e.call(this, t, function e(o, s) {
		...
		return t.prototype.bind = function(e, t, n) {
			...
			var s = this.tokenizer(n, this.options, function(t) {
				...
				}).length || ((t = o.option(n)).attr("data-select2-tag", !0), o._removeOldTags(), o.addOptions([t])), o.trigger("select", {
					data: n
				})
			});
			...
			for (var s = i.get("tokenSeparators") || [], r = n.term, a = 0, l = this.createTag || function(e) {
				...
				var c = r[a]; - 1 === e.inArray(c, s) ? a++ : (c = r.substr(0, a), null == (c = l(e.extend({}, n, {
					term: c
				}))) ? a++ : (o(c), r = r.substr(a + 1) || "", a = 0))
			}
			return {
				term: r
			}
		...
		return n.prototype.render = function(t) {
			t = t.call(this);
			var n = e('<span class="select2-search select2-search--dropdown"><input class="select2-search__field" type="search" tabindex="-1" autocomplete="off" autocorrect="off" autocapitalize="none" spellcheck="false" role="searchbox" aria-autocomplete="list" /></span>');
		...
		return n.prototype.bind = function(e, t, n) {
			...
			var o = this,
				...
				a = (i = "orientationchange.select2." + i.id, this.$container.parents().filter(t.hasScroll));
			a.each(function() {
			...
			}), e(window).on(s + " " + r + " " + i, function(e) {
				o._positionDropdown(), o._resizeDropdown()
			})
		}, n.prototype._detachPositioningHandler = function(n, i) {
			var o = "scroll.select2." + i.id,
				s = "resize.select2." + i.id;
			i = "orientationchange.select2." + i.id, this.$container.parents().filter(t.hasScroll).off(o), e(window).off(o + " " + s + " " + i)
		}, n.prototype._positionDropdown = function() {
			var t = e(window),
				n = this.$dropdown.hasClass("select2-dropdown--above"),
				i = this.$dropdown.hasClass("select2-dropdown--below"),
				o = null,
				s = ((l = this.$container.offset()).bottom = l.top + this.$container.outerHeight(!1), {
					height: this.$container.outerHeight(!1)
				});
			s.top = l.top, s.bottom = l.top + s.height;
			var r = this.$dropdown.outerHeight(!1),
				a = t.scrollTop(),
				l = (t = t.scrollTop() + t.height(), a = a < l.top - r, t = t > l.bottom + r, {
					left: l.left,
					top: s.bottom
				}),
				c = (c = "static" === (c = this.$dropdownParent).css("position") ? c.offsetParent() : c).offset();
			l.top -= c.top, l.left -= c.left, n || i || (o = "below"), t || !a || n ? !a && t && n && (o = "below") : o = "above", ("above" == o || n && "below" !== o) && (l.top = s.top - c.top - r), null != o && (this.$dropdown.removeClass("select2-dropdown--below select2-dropdown--above").addClass("select2-dropdown--" + o), this.$container.removeClass("select2-container--below select2-container--above").addClass("select2-container--" + o)), this.$dropdownContainer.css(l)
		...
		return t.prototype.bind = function(e, t, n) {
			...
			(!n || null == n.originalSelect2Event || "select" !== (n = n.originalSelect2Event)._type && "unselect" !== n._type) && ((n = this.getHighlightedResults()).length < 1 || null != (n = e.GetData(n[0], "data")).element && n.element.selected || null == n.element && n.selected || this.trigger("select", {
				data: n
			}))
		}, t
	...
	}), A.define("select2/defaults", ["jquery", "require", "./results", "./selection/single", "./selection/multiple", "./selection/placeholder", "./selection/allowClear", "./selection/search", "./selection/eventRelay", "./utils", "./translation", "./diacritics", "./data/select", "./data/array", "./data/ajax", "./data/tags", "./data/tokenizer", "./data/minimumInputLength", "./data/maximumInputLength", "./data/maximumSelectionLength", "./dropdown", "./dropdown/search", "./dropdown/hidePlaceholder", "./dropdown/infiniteScroll", "./dropdown/attachBody", "./dropdown/minimumResultsForSearch", "./dropdown/selectOnClose", "./dropdown/closeOnSelect", "./i18n/en"], function(e, t, n, i, o, s, r, a, l, c, u, d, p, h, f, g, m, y, v, _, w, $, b, A, x, S, D, C, E) {
		function O() {
			this.reset()
		}
		return O.prototype.apply = function(u) {
			null == (u = e.extend(!0, {}, this.defaults, u)).dataAdapter && (null != u.ajax ? u.dataAdapter = f : null != u.data ? u.dataAdapter = h : u.dataAdapter = p, 0 < u.minimumInputLength && (u.dataAdapter = c.Decorate(u.dataAdapter, y)), 0 < u.maximumInputLength && (u.dataAdapter = c.Decorate(u.dataAdapter, v)), 0 < u.maximumSelectionLength && (u.dataAdapter = c.Decorate(u.dataAdapter, _)), u.tags && (u.dataAdapter = c.Decorate(u.dataAdapter, g)), null == u.tokenSeparators && null == u.tokenizer || (u.dataAdapter = c.Decorate(u.dataAdapter, m)), null != u.query && (d = t(u.amdBase + "compat/query"), u.dataAdapter = c.Decorate(u.dataAdapter, d)), null != u.initSelection) && (d = t(u.amdBase + "compat/initSelection"), u.dataAdapter = c.Decorate(u.dataAdapter, d)), null == u.resultsAdapter && (u.resultsAdapter = n, null != u.ajax && (u.resultsAdapter = c.Decorate(u.resultsAdapter, A)), null != u.placeholder && (u.resultsAdapter = c.Decorate(u.resultsAdapter, b)), u.selectOnClose) && (u.resultsAdapter = c.Decorate(u.resultsAdapter, D)), null == u.dropdownAdapter && (u.multiple ? u.dropdownAdapter = w : (d = c.Decorate(w, $), u.dropdownAdapter = d), 0 !== u.minimumResultsForSearch && (u.dropdownAdapter = c.Decorate(u.dropdownAdapter, S)), u.closeOnSelect && (u.dropdownAdapter = c.Decorate(u.dropdownAdapter, C)), null == u.dropdownCssClass && null == u.dropdownCss && null == u.adaptDropdownCssClass || (d = t(u.amdBase + "compat/dropdownCss"), u.dropdownAdapter = c.Decorate(u.dropdownAdapter, d)), u.dropdownAdapter = c.Decorate(u.dropdownAdapter, x)), null == u.selectionAdapter && (u.multiple ? u.selectionAdapter = o : u.selectionAdapter = i, null != u.placeholder && (u.selectionAdapter = c.Decorate(u.selectionAdapter, s)), u.allowClear && (u.selectionAdapter = c.Decorate(u.selectionAdapter, r)), u.multiple && (u.selectionAdapter = c.Decorate(u.selectionAdapter, a)), null == u.containerCssClass && null == u.containerCss && null == u.adaptContainerCssClass || (d = t(u.amdBase + "compat/containerCss"), u.selectionAdapter = c.Decorate(u.selectionAdapter, d)), u.selectionAdapter = c.Decorate(u.selectionAdapter, l)), u.language = this._resolveLanguage(u.language), u.language.push("en");
			for (var d, E = [], O = 0; O < u.language.length; O++) {
				var T = u.language[O]; - 1 === E.indexOf(T) && E.push(T)
			}
			...
			var n = e.language,
				...
				o = t.prop("lang");
			return t = t.closest("[lang]").prop("lang"), o = Array.prototype.concat.call(this._resolveLanguage(o), this._resolveLanguage(n), this._resolveLanguage(i), this._resolveLanguage(t)), e.language = o, e
			...
			var i = {};
			i[e.camelCase(t)] = n, t = c._convertData(i), e.extend(!0, this.defaults, t)
		}, new O
	}), A.define("select2/options", ["require", "jquery", "./defaults", "./utils"], function(e, t, n, i) {
		function o(t, o) {
			this.options = t, null != o && this.fromElement(o), null != o && (this.options = n.applyFromElement(this.options, o)), this.options = n.apply(this.options), o && o.is("input") && (t = e(this.get("amdBase") + "compat/inputData"), this.options.dataAdapter = i.Decorate(this.options.dataAdapter, t))
		}
		return o.prototype.fromElement = function(e) {
			var n = ["select2"],
				o = (null == this.options.multiple && (this.options.multiple = e.prop("multiple")), null == this.options.disabled && (this.options.disabled = e.prop("disabled")), null == this.options.dir && (e.prop("dir") ? this.options.dir = e.prop("dir") : e.closest("[dir]").prop("dir") ? this.options.dir = e.closest("[dir]").prop("dir") : this.options.dir = "ltr"), e.prop("disabled", this.options.disabled), e.prop("multiple", this.options.multiple), i.GetData(e[0], "select2Tags") && (this.options.debug && window.console && console.warn && console.warn('Select2: The `data-select2-tags` attribute has been changed to use the `data-data` and `data-tags="true"` attributes and will be removed in future versions of Select2.'), i.StoreData(e[0], "data", i.GetData(e[0], "select2Tags")), i.StoreData(e[0], "tags", !0)), i.GetData(e[0], "ajaxUrl") && (this.options.debug && window.console && console.warn && console.warn("Select2: The `data-ajax-url` attribute has been changed to `data-ajax--url` and support for the old attribute will be removed in future versions of Select2."), e.attr("ajax--url", i.GetData(e[0], "ajaxUrl")), i.StoreData(e[0], "ajax-Url", i.GetData(e[0], "ajaxUrl"))), {});
			...
			for (var r = 0; r < e[0].attributes.length; r++) {
				var a = e[0].attributes[r].name,
					l = "data-";
				a.substr(0, l.length) == l && (a = a.substring(l.length), l = i.GetData(e[0], a), o[a.replace(/-([a-z])/g, s)] = l)
			}
			t.fn.jquery && "1." == t.fn.jquery.substr(0, 2) && e[0].dataset && (o = t.extend(!0, {}, e[0].dataset, o));
			var c, u = t.extend(!0, {}, i.GetData(e[0]), o);
			for (c in u = i._convertData(u)) - 1 < t.inArray(c, n) || (t.isPlainObject(this.options[c]) ? t.extend(this.options[c], u[c]) : this.options[c] = u[c]);
			return this
		...
		function o(e, i) {
			null != n.GetData(e[0], "select2") && n.GetData(e[0], "select2").destroy(), this.$element = e, this.id = this._generateId(e), this.options = new t(i = i || {}, e), o.__super__.constructor.call(this), i = e.attr("tabindex") || 0, n.StoreData(e[0], "old-tabindex", i), e.attr("tabindex", "-1"), i = this.options.get("dataAdapter"), this.dataAdapter = new i(e, this.options), i = this.render();
			var s = (this._placeContainer(i), this.options.get("selectionAdapter")),
				r = (this.selection = new s(e, this.options), this.$selection = this.selection.render(), this.selection.position(this.$selection, i), s = this.options.get("dropdownAdapter"), this.dropdown = new s(e, this.options), this.$dropdown = this.dropdown.render(), this.dropdown.position(this.$dropdown, i), s = this.options.get("resultsAdapter"), this.results = new s(e, this.options, this.dataAdapter), this.$results = this.results.render(), this.results.position(this.$results, this.$dropdown), this);
		...
		return n.Extend(o, n.Observable), o.prototype._generateId = function(e) {
			...
			var t = this,
				i = (this.$element.on("change.select2", function() {
			...
			t = t[0], e.isArray(t) && (t = e.map(t, function(e) {
				return e.toString()
		...
		return i.prototype.render = function(i) {
			i = i.call(this);
			var o, s = this.options.get("containerCssClass") || "",
				r = (e.isFunction(s) && (s = s(this.$element)), this.options.get("adaptContainerCssClass")),
				a = (r = r || n, -1 !== s.indexOf(":all:") && (s = s.replace(":all:", ""), o = r, r = function(e) {
					var t = o(e);
					return null != t ? t + " " + e : e
				}), this.options.get("containerCss") || {});
			return e.isFunction(a) && (a = a(this.$element)), t.syncCssClasses(i, this.$element, r), i.css(a), i.addClass(s), i
		}, i
		...
		return i.prototype.render = function(i) {
			i = i.call(this);
			var o, s = this.options.get("dropdownCssClass") || "",
				r = (e.isFunction(s) && (s = s(this.$element)), this.options.get("adaptDropdownCssClass")),
				a = (r = r || n, -1 !== s.indexOf(":all:") && (s = s.replace(":all:", ""), o = r, r = function(e) {
					var t = o(e);
					return null != t ? t + " " + e : e
		...
		return n.prototype.current = function(t, n) {
			for (var i = [], o = 0; o < this._currentData.length; o++) {
				...
				i.push.apply(i, function t(n, i) {
					var o = [];
					return n.selected || -1 !== e.inArray(n.id, i) ? (n.selected = !0, o.push(n)) : n.selected = !1, n.children && o.push.apply(o, t(n.children, i)), o
				}(s, this.$element.val().split(this._valueSeparator)))
			}
			n(i)
		}, n.prototype.select = function(t, n) {
			var i;
			this.options.get("multiple") ? (i = this.$element.val(), i += this._valueSeparator + n.id, this.$element.val(i)) : (this.current(function(t) {
				e.map(t, function(e) {
					e.selected = !1
				})
			...
			for (var i = [], o = 0; o < this._currentData.length; o++) {
				var s = this._currentData[o];
				null !== (s = this.matches(t, s)) && i.push(s)
			}
			n({
				results: i
			})
		...
		var a = e.event.special.mousewheel = {
			...
			getLineHeight: function(t) {
				var n = (t = e(t))["offsetParent" in e.fn ? "offsetParent" : "parent"]();
				return n.length || (n = e("body")), parseInt(n.css("fontSize"), 10) || parseInt(t.css("fontSize"), 10) || 16
			},
	...
	}, "function" == typeof A.define && A.define.amd ? A.define("jquery-mousewheel", ["jquery"], f) : "object" == typeof exports ? module.exports = f : f(e), A.define("jquery.select2", ["jquery", "jquery-mousewheel", "./select2/core", "./select2/defaults", "./select2/utils"], function(e, t, n, i, o) {
		var s;
	...
	var t, n, i, o, s, r, a, l, c, u, d, p, h, f, g = {
		define: A.define,
		require: A.require
	};
	...
	function y(e, t) {
		var n, i, o, s, r, a, l, u, d, p, f = t && t.split("/"),
			g = c.map,
			m = g && g["*"] || {};
		if (e) {
			for (t = (e = e.split("/")).length - 1, c.nodeIdCompat && h.test(e[t]) && (e[t] = e[t].replace(h, "")), "." === e[0].charAt(0) && f && (e = f.slice(0, f.length - 1).concat(e)), u = 0; u < e.length; u++) "." === (p = e[u]) ? (e.splice(u, 1), --u) : ".." !== p || 0 === u || 1 === u && ".." === e[2] || ".." === e[u - 1] || 0 < u && (e.splice(u - 1, 2), u -= 2);
			e = e.join("/")
		}
		if ((f || m) && g) {
	...
	function _(e) {
		var t;
		if (m(l, e) && (t = l[e], delete l[e], u[e] = !0, i.apply(n, t)), m(a, e) || m(u, e)) return a[e];
	...
	var A = g.require("jquery.select2");
	return e.fn.select2.amd = g, A
});